...
(function() {
  ...
  LightboxOptions = (function() {
    ...
    function LightboxOptions() {
      this.fileLoadingImage = '/static/images/lightbox/loading.gif';
      this.fileCloseImage = '/static/images/lightbox/close.png';
  ...
  Lightbox = (function() {
    ...
    Lightbox.prototype.start = function($link) {
      ...
      $window = $(window);
      top = $window.scrollTop() + $window.height() / 32;
    ...
    Lightbox.prototype.updateDetails = function() {
      ...
      if (this.album.length > 1) {
        $lightbox.find('.lb-number').html(" Map/Image "  + (this.currentImageIndex + 1) + ' ' + this.options.labelOf + ' ' + this.album.length).fadeIn('fast');
      } else {
