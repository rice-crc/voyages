  ...
  timeline: {
    chart: {
      ...
      options: [ // this is a workaround to be having unique keys submitted to the backend: ##var_name; maps to globals.py > voyage_timeline_variables
        ...
        { id: 9, varName: "13var_imp_total_num_slaves_purchased", label: "Total number of slaves embarked*" },
        { id: 10, varName: "14var_imp_total_num_slaves_purchased", label: "Average number of slaves embarked" },
        { id: 11, varName: "15var_imp_total_slaves_disembarked", label: "Total number of slaves disembarked*" },
        { id: 12, varName: "16var_imp_total_slaves_disembarked", label: "Average number of slaves disembarked" },
        { id: 13, varName: "17var_imputed_percentage_men", label: "Percentage men (among slaves)" },
        { id: 14, varName: "18var_imputed_percentage_women", label: "Percentage women (among slaves)" },
        { id: 15, varName: "19var_imputed_percentage_boys", label: "Percentage boys (among slaves)" },
        { id: 16, varName: "20var_imputed_percentage_girls", label: "Percentage girls (among slaves)" },
        { id: 17, varName: "21var_imputed_percentage_female", label: "Percentage female (among slaves)" },
        { id: 18, varName: "22var_imputed_percentage_male", label: "Percentage male (among slaves)" },
