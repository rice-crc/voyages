  ...
  timeline: {
    chart: {
      ...
      options: [
        ...
        { id: 1, varName: "var_tonnage_mod", label: "Average tonnage (standardized)" },
        { id: 2, varName: "var_guns_mounted", label: "Average number of guns" },
        { id: 3, varName: "var_resistance_idnum", label: "Rate of resistance" },
        { id: 4, varName: "var_imp_length_home_to_disembark", label: "Average duration of voyage from home port to disembarkation (days)" },
        { id: 5, varName: "var_length_middle_passage_days", label: "Average duration of middle passage (days)" },
        { id: 6, varName: "var_crew_voyage_outset", label: "Average crew at outset" },
        { id: 7, varName: "var_crew_first_landing", label: "Average crew at first landing of slaves" },
        { id: 8, varName: "var_crew_died_complete_voyage", label: "Average crew deaths" },
        { id: 9, varName: "var_imp_total_num_slaves_purchased", label: "Total number of captives embarked" },
        { id: 10, varName: "var_total_num_slaves_purchased", label: "Average number of captives embarked" },
        { id: 11, varName: "var_imp_total_slaves_disembarked", label: "Total number of captives disembarked" },
        { id: 12, varName: "var_imp_total_slaves_disembarked", label: "Average number of captives disembarked" },
        { id: 13, varName: "var_imputed_percentage_men", label: "Percentage men (among captives)" },
        { id: 14, varName: "var_imputed_percentage_women", label: "Percentage women (among captives)" },
        { id: 15, varName: "var_imputed_percentage_boys", label: "Percentage boys (among captives)" },
        { id: 16, varName: "var_imputed_percentage_girls", label: "Percentage girls (among captives)" },
        { id: 17, varName: "var_imputed_percentage_female", label: "Percentage female (among captives)" },
        { id: 18, varName: "var_imputed_percentage_male", label: "Percentage male (among captives)" },
        { id: 19, varName: "var_imputed_sterling_cash", label: "Sterling cash price in Jamaica*" },
        { id: 20, varName: "var_imputed_mortality", label: "Average percentage of slaves embarked who died during the voyage" }
      ],
    },
  },
}
