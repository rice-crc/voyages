...
var tabs = {
  ...
  tables: {
    row: {
      ...
      value: 12,
      options: [{ id: 0, label: gettext("Flag*")},
      {id: 1, label: gettext("Broad region where voyage began")},
      {id: 2, label: gettext("Region where voyage began")},
      {id: 3, label: gettext("Port where voyage began*")},
      {id: 4, label: gettext("Embarkation regions")},
      {id: 5, label: gettext("Principal place of purchase*")},
      {id: 6, label: gettext("Specific regions of disembarkation")},
      {id: 7, label: gettext("Broad regions of disembarkation")},
      {id: 8, label: gettext("Principal place of landing*")},
      {id: 9, label: gettext("Individual years*")},
      {id: 10, label: gettext("5-year periods"), range: makeYearRange(5)},
      {id: 11, label: gettext("10-year periods"), range: makeYearRange(10)},
      {id: 12, label: gettext("25-year periods"), range: makeYearRange(25)},
      {id: 13, label: gettext("50-year periods"), range: makeYearRange(50)},
      {id: 14, label: gettext("100-year periods"), range: makeYearRange(100)}],
    },
    column: {
      // currently selected value
