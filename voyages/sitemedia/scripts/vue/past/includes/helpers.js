...
// 				console.log(source_coords,target_coords)
				...
				if (tmp_edge_dict[source_leaflet_id]) {
					if (tmp_edge_dict[source_leaflet_id][target_leaflet_id]) {
						...
						tmp_edge_dict[source_leaflet_id][target_leaflet_id]={'weight':edge.weight,'source_latlng':source_coords,'target_latlng':target_coords,'geometry':straightlinebezier(source_coords,target_coords),'leg_type':edge.leg_type}
					}
				} else {
