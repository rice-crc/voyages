...
urlpatterns = patterns('',
    url(r'^$', TemplateView.as_view(template_name='about/index.html'), name='index'),
    ...
    url(r'^acknowledgements$', TemplateView.as_view(template_name='about/acknowledgements.html'), name='acknowledgements'),
