...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AfricanName.embarkation'
        db.delete_column(u'resources_africanname', 'embarkation_id')

        # Adding field 'AfricanName.embarkation_port'
        db.add_column(u'resources_africanname', 'embarkation_port',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='embarkation_port', to_field='value', null=True, to=orm['voyage.Place']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AfricanName.embarkation'
        db.add_column(u'resources_africanname', 'embarkation',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='embarkation_port', to_field='value', null=True, to=orm['voyage.Place'], blank=True),
                      keep_default=False)

        # Deleting field 'AfricanName.embarkation_port'
        db.delete_column(u'resources_africanname', 'embarkation_port_id')
    ...
    models = {
        u'resources.africanname': {
            ...
            'embarkation_port': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'embarkation_port'", 'to_field': "'value'", 'null': 'True', 'to': u"orm['voyage.Place']"}),
