...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'resources_image', (
            ...
            ('comments', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
            ('other_references', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('emory', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('emory_location', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('authorization_status', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('image_status', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('date', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True)),
            ('external_id', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resources.ImageCategory'])),
            ('voyage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['voyage.Voyage'], null=True, blank=True)),
    ...
    models = {
        u'resources.image': {
            'Meta': {'ordering': "['date', 'image_id']", 'object_name': 'Image'},
            'authorization_status': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'emory_location': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'external_id': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'height': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'image_status': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'mime_type': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'order_num': ('django.db.models.fields.IntegerField', [], {}),
            'other_references': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
