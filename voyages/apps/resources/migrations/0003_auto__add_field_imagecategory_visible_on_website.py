...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageCategory.visible_on_website'
        db.add_column(u'resources_imagecategory', 'visible_on_website',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImageCategory.visible_on_website'
        db.delete_column(u'resources_imagecategory', 'visible_on_website')
