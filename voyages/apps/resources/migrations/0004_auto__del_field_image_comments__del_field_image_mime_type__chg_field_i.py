...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Image.comments'
        db.delete_column(u'resources_image', 'comments')

        # Deleting field 'Image.mime_type'
        db.delete_column(u'resources_image', 'mime_type')


        # Changing field 'Image.description'
        db.alter_column(u'resources_image', 'description', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'Image.order_num'
        db.alter_column(u'resources_image', 'order_num', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

    def backwards(self, orm):
        # Adding field 'Image.comments'
        db.add_column(u'resources_image', 'comments',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.mime_type'
        db.add_column(u'resources_image', 'mime_type',
    ...
    models = {
        u'resources.image': {
            ...
            'order_num': ('django.db.models.fields.IntegerField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
        ...
        u'resources.imagecategory': {
            ...
            'visible_on_website': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
