...
class EnslaverRole(models.Model):
    """
    Controlled vocabulary of enslavers' roles w.r.t. voyages and relations of enslavement
    """
...
class EnslaverVoyageConnection(models.Model):
    ...
    voyage = models.ForeignKey('voyage.Voyage',
                               null=False,
                               on_delete=models.CASCADE)
    role = models.ForeignKey('EnslaverRole',
                            null=False,
                            on_delete=models.CASCADE)
...
class EnslavementRelationType(models.Model):
    """
    controlled vocabulary for enslavement relation types
    """
...
class EnslaverInRelation(models.Model):
    ...
    role = models.ForeignKey('EnslaverRole',
                            null=False,
                            on_delete=models.CASCADE,
                            help_text="The role of the enslaver in this relation")
