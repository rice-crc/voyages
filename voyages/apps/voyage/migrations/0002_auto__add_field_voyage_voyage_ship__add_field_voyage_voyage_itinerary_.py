...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voyage.voyage_ship'
        db.add_column(u'voyage_voyage', 'voyage_ship',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='voyage_ship', null=True, to=orm['voyage.VoyageShip']),
                      keep_default=False)

        # Adding field 'Voyage.voyage_itinerary'
        db.add_column(u'voyage_voyage', 'voyage_itinerary',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='voyage_itinerary', null=True, to=orm['voyage.VoyageItinerary']),
                      keep_default=False)

        # Adding field 'Voyage.voyage_dates'
        db.add_column(u'voyage_voyage', 'voyage_dates',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='voyage_dates', null=True, to=orm['voyage.VoyageDates']),
                      keep_default=False)

        # Adding field 'Voyage.voyage_crew'
        db.add_column(u'voyage_voyage', 'voyage_crew',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='voyage_crew', null=True, to=orm['voyage.VoyageCrew']),
                      keep_default=False)

        # Adding field 'Voyage.voyage_slaves_numbers'
        db.add_column(u'voyage_voyage', 'voyage_slaves_numbers',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='voyage_slaves_numbers', null=True, to=orm['voyage.VoyageSlavesNumbers']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voyage.voyage_ship'
        db.delete_column(u'voyage_voyage', 'voyage_ship_id')

        # Deleting field 'Voyage.voyage_itinerary'
        db.delete_column(u'voyage_voyage', 'voyage_itinerary_id')

        # Deleting field 'Voyage.voyage_dates'
        db.delete_column(u'voyage_voyage', 'voyage_dates_id')

        # Deleting field 'Voyage.voyage_crew'
        db.delete_column(u'voyage_voyage', 'voyage_crew_id')

        # Deleting field 'Voyage.voyage_slaves_numbers'
        db.delete_column(u'voyage_voyage', 'voyage_slaves_numbers_id')
