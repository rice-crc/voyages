...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoyageSlavesNumbers.imp_total_num_slaves_embarked'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_total_num_slaves_embarked',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoyageSlavesNumbers.imp_total_num_slaves_embarked'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_total_num_slaves_embarked')
