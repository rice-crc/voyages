...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VoyageSourcesType'
        db.create_table(u'voyage_voyagesourcestype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group_id', self.gf('django.db.models.fields.IntegerField')(max_length=1)),
            ('group_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'voyage', ['VoyageSourcesType'])

        # Adding field 'VoyageSources.source_type'
        db.add_column(u'voyage_voyagesources', 'source_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['voyage.VoyageSourcesType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VoyageSourcesType'
        db.delete_table(u'voyage_voyagesourcestype')

        # Deleting field 'VoyageSources.source_type'
        db.delete_column(u'voyage_voyagesources', 'source_type_id')
