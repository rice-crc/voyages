...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoyageSlavesNumbers.imp_total_num_slaves_disembarked'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_total_num_slaves_disembarked',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_jamaican_cash_price'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_jamaican_cash_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_mortality_during_voyage'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_mortality_during_voyage',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_men_total'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_men_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_women_total'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_women_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_boy_total'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_boy_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_girl_total'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_girl_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_adult_total'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_adult_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_child_total'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_child_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_infant_total'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_infant_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_males_total'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_males_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_females_total'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_females_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoyageSlavesNumbers.imp_total_num_slaves_disembarked'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_total_num_slaves_disembarked')

        # Deleting field 'VoyageSlavesNumbers.imp_jamaican_cash_price'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_jamaican_cash_price')

        # Deleting field 'VoyageSlavesNumbers.imp_mortality_during_voyage'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_mortality_during_voyage')

        # Deleting field 'VoyageSlavesNumbers.imp_num_men_total'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_men_total')

        # Deleting field 'VoyageSlavesNumbers.imp_num_women_total'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_women_total')

        # Deleting field 'VoyageSlavesNumbers.imp_num_boy_total'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_boy_total')

        # Deleting field 'VoyageSlavesNumbers.imp_num_girl_total'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_girl_total')

        # Deleting field 'VoyageSlavesNumbers.imp_num_adult_total'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_adult_total')

        # Deleting field 'VoyageSlavesNumbers.imp_num_child_total'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_child_total')

        # Deleting field 'VoyageSlavesNumbers.imp_num_infant_total'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_infant_total')

        # Deleting field 'VoyageSlavesNumbers.imp_num_males_total'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_males_total')

        # Deleting field 'VoyageSlavesNumbers.imp_num_females_total'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_females_total')
    ...
    models = {
        ...
        u'voyage.voyageslavesnumbers': {
            ...
            'imp_num_infant_total': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
