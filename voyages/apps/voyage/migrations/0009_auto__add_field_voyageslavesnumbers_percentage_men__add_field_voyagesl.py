...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoyageSlavesNumbers.percentage_men'
        db.add_column(u'voyage_voyageslavesnumbers', 'percentage_men',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.percentage_women'
        db.add_column(u'voyage_voyageslavesnumbers', 'percentage_women',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.percentage_boy'
        db.add_column(u'voyage_voyageslavesnumbers', 'percentage_boy',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.percentage_girl'
        db.add_column(u'voyage_voyageslavesnumbers', 'percentage_girl',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.percentage_male'
        db.add_column(u'voyage_voyageslavesnumbers', 'percentage_male',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.percentage_child'
        db.add_column(u'voyage_voyageslavesnumbers', 'percentage_child',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.percentage_adult'
        db.add_column(u'voyage_voyageslavesnumbers', 'percentage_adult',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.percentage_female'
        db.add_column(u'voyage_voyageslavesnumbers', 'percentage_female',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoyageSlavesNumbers.percentage_men'
        db.delete_column(u'voyage_voyageslavesnumbers', 'percentage_men')

        # Deleting field 'VoyageSlavesNumbers.percentage_women'
        db.delete_column(u'voyage_voyageslavesnumbers', 'percentage_women')

        # Deleting field 'VoyageSlavesNumbers.percentage_boy'
        db.delete_column(u'voyage_voyageslavesnumbers', 'percentage_boy')

        # Deleting field 'VoyageSlavesNumbers.percentage_girl'
        db.delete_column(u'voyage_voyageslavesnumbers', 'percentage_girl')

        # Deleting field 'VoyageSlavesNumbers.percentage_male'
        db.delete_column(u'voyage_voyageslavesnumbers', 'percentage_male')

        # Deleting field 'VoyageSlavesNumbers.percentage_child'
        db.delete_column(u'voyage_voyageslavesnumbers', 'percentage_child')

        # Deleting field 'VoyageSlavesNumbers.percentage_adult'
        db.delete_column(u'voyage_voyageslavesnumbers', 'percentage_adult')

        # Deleting field 'VoyageSlavesNumbers.percentage_female'
        db.delete_column(u'voyage_voyageslavesnumbers', 'percentage_female')
