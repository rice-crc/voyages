...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoyageDates.date_departed_africa'
        db.add_column(u'voyage_voyagedates', 'date_departed_africa',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoyageDates.date_departed_africa'
        db.delete_column(u'voyage_voyagedates', 'date_departed_africa')
