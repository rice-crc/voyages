...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Voyage', fields ['voyage_id']
        db.delete_unique(u'voyage_voyage', ['voyage_id'])


        # Changing field 'Voyage.voyage_id'
        db.alter_column(u'voyage_voyage', 'voyage_id', self.gf('django.db.models.fields.IntegerField')(null=True))
