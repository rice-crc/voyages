...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'voyage_voyagedates', (
            ...
            ('length_middle_passage_days', self.gf('django.db.models.fields.IntegerField')(max_length=6, null=True, blank=True)),
            ('imp_voyage_began', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=10, null=True, blank=True)),
            ('imp_departed_africa', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=10, null=True, blank=True)),
            ('imp_arrival_at_port_of_dis', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=10, null=True, blank=True)),
            ('imp_length_home_to_disembark', self.gf('django.db.models.fields.IntegerField')(max_length=6, null=True, blank=True)),
            ('imp_length_leaving_africa_to_disembark', self.gf('django.db.models.fields.IntegerField')(max_length=6, null=True, blank=True)),
        ...
        db.create_table(u'voyage_nationality', (
            ...
            ('value', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
        ))
        ...
        db.create_table(u'voyage_voyageitinerary', (
            ...
            ('int_second_place_region_slave_landing', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='int_second_region_slave_landing', null=True, to=orm['voyage.Region'])),
            ...
            ('number_of_ports_of_call', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('broad_region_of_return', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='broad_region_of_return', null=True, to=orm['voyage.BroadRegion'])),
        ...
        db.create_table(u'voyage_voyageslavesnumbers', (
            ...
            ('voyage', self.gf('django.db.models.fields.related.ForeignKey')(related_name='voyage_name_slave_characteristics', to=orm['voyage.Voyage'])),
        ))
        ...
        db.create_table(u'voyage_voyagesourcesconnection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='source', null=True, to=orm['voyage.VoyageSources'])),
        ...
        db.create_table(u'voyage_broadregion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('broad_region', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('value', self.gf('django.db.models.fields.IntegerField')(max_length=5)),
        ...
        db.create_table(u'voyage_voyageship', (
            ...
            ('tonnage_mod', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=1, blank=True)),
        ...
        db.create_table(u'voyage_voyagecrew', (
            ...
            ('crew_died_middle_passage', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
        ...
        db.create_table(u'voyage_region', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=70)),
        ...
        db.create_table(u'voyage_voyage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('voyage_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('voyage_in_cd_rom', self.gf('django.db.models.fields.BooleanField')(default=False, max_length=1)),
            ('voyage_groupings', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['voyage.VoyageGroupings'], null=True, blank=True)),
            ...
            ('voyage_itinerary', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='voyage_itinerary', null=True, to=orm['voyage.VoyageItinerary'])),
            ('voyage_dates', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='voyage_dates', null=True, to=orm['voyage.VoyageDates'])),
            ('voyage_crew', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='voyage_crew', null=True, to=orm['voyage.VoyageCrew'])),
            ('voyage_slaves_numbers', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='voyage_slaves_numbers', null=True, to=orm['voyage.VoyageSlavesNumbers'])),
        ))
        ...
        db.create_table(u'voyage_place', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('place', self.gf('django.db.models.fields.CharField')(max_length=70)),
