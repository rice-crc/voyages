...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoyageSlavesNumbers.imp_num_adult_embarked'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_adult_embarked',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_children_embarked'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_children_embarked',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_male_embarked'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_male_embarked',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_female_embarked'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_female_embarked',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.total_slaves_embarked_age_identified'
        db.add_column(u'voyage_voyageslavesnumbers', 'total_slaves_embarked_age_identified',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.total_slaves_embarked_gender_identified'
        db.add_column(u'voyage_voyageslavesnumbers', 'total_slaves_embarked_gender_identified',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_adult_death_middle_passage'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_adult_death_middle_passage',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_child_death_middle_passage'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_child_death_middle_passage',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_male_death_middle_passage'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_male_death_middle_passage',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_female_death_middle_passage'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_female_death_middle_passage',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_adult_landed'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_adult_landed',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_child_landed'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_child_landed',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_male_landed'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_male_landed',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_num_female_landed'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_num_female_landed',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.total_slaves_landed_age_identified'
        db.add_column(u'voyage_voyageslavesnumbers', 'total_slaves_landed_age_identified',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.total_slaves_landed_gender_identified'
        db.add_column(u'voyage_voyageslavesnumbers', 'total_slaves_landed_gender_identified',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.total_slaves_dept_or_arr_age_identified'
        db.add_column(u'voyage_voyageslavesnumbers', 'total_slaves_dept_or_arr_age_identified',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.total_slaves_dept_or_arr_gender_identified'
        db.add_column(u'voyage_voyageslavesnumbers', 'total_slaves_dept_or_arr_gender_identified',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoyageSlavesNumbers.imp_slaves_embarked_for_mortality'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_slaves_embarked_for_mortality',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoyageSlavesNumbers.imp_num_adult_embarked'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_adult_embarked')

        # Deleting field 'VoyageSlavesNumbers.imp_num_children_embarked'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_children_embarked')

        # Deleting field 'VoyageSlavesNumbers.imp_num_male_embarked'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_male_embarked')

        # Deleting field 'VoyageSlavesNumbers.imp_num_female_embarked'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_female_embarked')

        # Deleting field 'VoyageSlavesNumbers.total_slaves_embarked_age_identified'
        db.delete_column(u'voyage_voyageslavesnumbers', 'total_slaves_embarked_age_identified')

        # Deleting field 'VoyageSlavesNumbers.total_slaves_embarked_gender_identified'
        db.delete_column(u'voyage_voyageslavesnumbers', 'total_slaves_embarked_gender_identified')

        # Deleting field 'VoyageSlavesNumbers.imp_adult_death_middle_passage'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_adult_death_middle_passage')

        # Deleting field 'VoyageSlavesNumbers.imp_child_death_middle_passage'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_child_death_middle_passage')

        # Deleting field 'VoyageSlavesNumbers.imp_male_death_middle_passage'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_male_death_middle_passage')

        # Deleting field 'VoyageSlavesNumbers.imp_female_death_middle_passage'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_female_death_middle_passage')

        # Deleting field 'VoyageSlavesNumbers.imp_num_adult_landed'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_adult_landed')

        # Deleting field 'VoyageSlavesNumbers.imp_num_child_landed'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_child_landed')

        # Deleting field 'VoyageSlavesNumbers.imp_num_male_landed'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_male_landed')

        # Deleting field 'VoyageSlavesNumbers.imp_num_female_landed'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_num_female_landed')

        # Deleting field 'VoyageSlavesNumbers.total_slaves_landed_age_identified'
        db.delete_column(u'voyage_voyageslavesnumbers', 'total_slaves_landed_age_identified')

        # Deleting field 'VoyageSlavesNumbers.total_slaves_landed_gender_identified'
        db.delete_column(u'voyage_voyageslavesnumbers', 'total_slaves_landed_gender_identified')

        # Deleting field 'VoyageSlavesNumbers.total_slaves_dept_or_arr_age_identified'
        db.delete_column(u'voyage_voyageslavesnumbers', 'total_slaves_dept_or_arr_age_identified')

        # Deleting field 'VoyageSlavesNumbers.total_slaves_dept_or_arr_gender_identified'
        db.delete_column(u'voyage_voyageslavesnumbers', 'total_slaves_dept_or_arr_gender_identified')

        # Deleting field 'VoyageSlavesNumbers.imp_slaves_embarked_for_mortality'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_slaves_embarked_for_mortality')
