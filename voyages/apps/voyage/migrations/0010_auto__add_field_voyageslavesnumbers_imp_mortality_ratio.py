...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoyageSlavesNumbers.imp_mortality_ratio'
        db.add_column(u'voyage_voyageslavesnumbers', 'imp_mortality_ratio',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoyageSlavesNumbers.imp_mortality_ratio'
        db.delete_column(u'voyage_voyageslavesnumbers', 'imp_mortality_ratio')
