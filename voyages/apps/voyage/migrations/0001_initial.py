...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'voyage_tontype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ton_type', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('code', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
        ))
        ...
        db.create_table(u'voyage_voyagedates', (
            ...
            ('imp_arrival_at_port_of_dis', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=10)),
    ...
    models = {
        ...
        u'voyage.tontype': {
            ...
            'code': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ton_type': ('django.db.models.fields.CharField', [], {'max_length': '70'})
        },
        ...
        u'voyage.voyagedates': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imp_arrival_at_port_of_dis': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '10'}),
