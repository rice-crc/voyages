...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Nationality.label'
        db.alter_column(u'voyage_nationality', 'label', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'VoyageShipOwner.name'
        db.alter_column(u'voyage_voyageshipowner', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'VoyageSourcesConnection.text_ref'
        db.alter_column(u'voyage_voyagesourcesconnection', 'text_ref', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Resistance.label'
        db.alter_column(u'voyage_resistance', 'label', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'VoyageSources.full_ref'
        db.alter_column(u'voyage_voyagesources', 'full_ref', self.gf('django.db.models.fields.CharField')(max_length=2550, null=True))

        # Changing field 'VoyageSources.short_ref'
        db.alter_column(u'voyage_voyagesources', 'short_ref', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'BroadRegion.broad_region'
        db.alter_column(u'voyage_broadregion', 'broad_region', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'TonType.label'
        db.alter_column(u'voyage_tontype', 'label', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'VoyageShip.ship_name'
        db.alter_column(u'voyage_voyageship', 'ship_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Region.region'
        db.alter_column(u'voyage_region', 'region', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'VoyageCaptain.name'
        db.alter_column(u'voyage_voyagecaptain', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Place.place'
        db.alter_column(u'voyage_place', 'place', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Nationality.label'
        db.alter_column(u'voyage_nationality', 'label', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'VoyageShipOwner.name'
        db.alter_column(u'voyage_voyageshipowner', 'name', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'VoyageSourcesConnection.text_ref'
        db.alter_column(u'voyage_voyagesourcesconnection', 'text_ref', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Resistance.label'
        db.alter_column(u'voyage_resistance', 'label', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'VoyageSources.full_ref'
        db.alter_column(u'voyage_voyagesources', 'full_ref', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'VoyageSources.short_ref'
        db.alter_column(u'voyage_voyagesources', 'short_ref', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'BroadRegion.broad_region'
        db.alter_column(u'voyage_broadregion', 'broad_region', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'TonType.label'
        db.alter_column(u'voyage_tontype', 'label', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'VoyageShip.ship_name'
        db.alter_column(u'voyage_voyageship', 'ship_name', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))

        # Changing field 'Region.region'
        db.alter_column(u'voyage_region', 'region', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'VoyageCaptain.name'
        db.alter_column(u'voyage_voyagecaptain', 'name', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'Place.place'
        db.alter_column(u'voyage_place', 'place', self.gf('django.db.models.fields.CharField')(max_length=70))

    models = {
        u'voyage.broadregion': {
            'Meta': {'ordering': "['value']", 'object_name': 'BroadRegion'},
            'broad_region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'voyage.voyageship': {
            ...
            'ship_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'voyage.voyagesources': {
            ...
            'full_ref': ('django.db.models.fields.CharField', [], {'max_length': '2550', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'short_ref': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'voyage.voyagesourcesconnection': {
            ...
            'text_ref': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
