...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Place', fields ['value']
        db.create_unique(u'voyage_place', ['value'])


    def backwards(self, orm):
        # Removing unique constraint on 'Place', fields ['value']
        db.delete_unique(u'voyage_place', ['value'])
