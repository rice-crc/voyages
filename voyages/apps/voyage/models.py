...
class VoyageCaptainConnection(models.Model):
    """
    Represents the relationship between VoyageCaptain and Voyage
    captain_order determines the order of captains (first, second, ...)
    related to: :model:`voyages.apps.voyages.Voyage`
    """
...
class VoyageSlavesNumbers(models.Model):
    ...
    num_adult_disembark_second_landing = models.IntegerField \
            ("Number of adults (gender unspecified) (ADULT6) "
    ...
    num_males_disembark_second_landing = models.IntegerField \
            ("Number of males (age unspecified) (MALE6) disembarked "
             "at second place of landing",
             null=True, blank=True)
    # Representing FEMALE6 variables
    num_females_disembark_second_landing = models.IntegerField \
            ("Number of females (age unspecified) (FEMALE6) disembarked "
             "at second place of landing",
             null=True, blank=True)

    voyage = models.ForeignKey\
            ('Voyage', null=True, blank=True,
...
class VoyageSourcesConnection(models.Model):
    ...
    text_ref = models.CharField(_('Text reference(citation)'), max_length=100,
                                null=True, blank=True)
