...
urlpatterns = [
    ...
    url(r'save-query', voyages.apps.voyage.search_views.save_query, name='save-query'),
    url(r'get-saved-query/(?P<query_id>\w+)', voyages.apps.voyage.search_views.get_saved_query, name='get-saved-query'),
