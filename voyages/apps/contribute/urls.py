...
urlpatterns = [
    ...
    url(r'download_voyages_status', views.download_voyages_status, name='download_voyages_status'),
    url(r'download_voyages_go', views.download_voyages_go, name='download_voyages_go'),
