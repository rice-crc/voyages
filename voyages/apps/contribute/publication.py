...
def _map_voyage_to_spss(voyage):
    ...
    data['MAJBYIMP'] = _get_label_value(itinerary.imp_principal_region_of_slave_purchase)
    data['MAJBYIMP1'] = _get_label_value(itinerary.imp_broad_region_of_slave_purchase)
    data['MJSLPTIMP'] = _get_label_value(itinerary.imp_principal_port_slave_dis)
    data['MJSELIMP'] = _get_label_value(itinerary.imp_principal_region_slave_dis)
