...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('notes', models.TextField(help_text=b'Notes for the contribution', max_length=10000, verbose_name=b'Notes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(help_text=b'Notes for the interim voyage', max_length=10000, null=True, verbose_name=b'Notes', blank=True)),
                ('african_resistance', models.ForeignKey(related_name='+', blank=True, to='voyage.Resistance', null=True)),
                ('first_place_of_landing', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('first_place_of_slave_purchase', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('first_port_intended_disembarkation', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('first_port_intended_embarkation', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('national_carrier', models.ForeignKey(related_name='+', blank=True, to='voyage.Nationality', null=True)),
                ('place_of_call_before_atlantic_crossing', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('port_of_departure', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('port_voyage_ended', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('principal_place_of_slave_disembarkation', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('principal_place_of_slave_purchase', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('rig_of_vessel', models.ForeignKey(related_name='+', blank=True, to='voyage.RigOfVessel', null=True)),
                ('second_place_of_landing', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('second_place_of_slave_purchase', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('second_port_intended_disembarkation', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('second_port_intended_embarkation', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('ship_construction_place', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('ship_registration_place', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('third_place_of_landing', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('third_place_of_slave_purchase', models.ForeignKey(related_name='+', blank=True, to='voyage.Place', null=True)),
                ('ton_type', models.ForeignKey(related_name='+', blank=True, to='voyage.TonType', null=True)),
                ('voyage_outcome', models.ForeignKey(related_name='+', blank=True, to='voyage.ParticularOutcome', null=True)),
            ],
        ),
        migrations.CreateModel(
