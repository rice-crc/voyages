    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_voyage_sources', models.ForeignKey(related_name='+', to='voyage.VoyageSources', null=True)),
                ('interim_voyage', models.ForeignKey(related_name='private_note_or_collection_sources', to='contribute.InterimVoyage')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.CharField(max_length=20, null=True, blank=True)),
                ('created_voyage_sources', models.ForeignKey(related_name='+', to='voyage.VoyageSources', null=True)),
                ('interim_voyage', models.ForeignKey(related_name='unpublished_secondary_sources', to='contribute.InterimVoyage')),
            ],
            options={
                'abstract': False,
            },
